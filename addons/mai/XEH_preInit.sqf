...
[
	...
	// Title, Tooltip
	[
		localize "STR_MAI_editWaypoints",
		localize "STR_MAI_editWaypointsShort"
	],
	// Category, Subcategory
	["MAI", "1. Main"],
	// Extra params, depending on settings type
...
[
	// Global var name
	"MAI_unitSuppressFactor",
	// Setting type
	"SLIDER",
	// Title, Tooltip
	[
		localize "STR_MAI_unitSuppressFactor",
		localize "STR_MAI_unitSuppressFactorShort"
	],
	// Category, Subcategory
	["MAI", "2. AI PTSD"],
	// Extra params, depending on settings type
...
[
	...
	// Title, Tooltip
	[
		localize "STR_MAI_dynamicCamoCoef",
		localize "STR_MAI_dynamicCamoCoefShort"
	],
	// Category, Subcategory
	["MAI", "3. Sight Adjust"],
	// Extra params, depending on settings type
	...
	true,
	// Init/Change script
	{if (missionNamespace getVariable ["MAI_dynamicCamoCoefLoopActive", false]) then {call MAI_fnc_playerCamoCoef}},
	// Needs mission restart
	false
] call CBA_Settings_fnc_init;
...
[
	...
	// Title, Tooltip
	[
		localize "STR_MAI_useRadio",
		localize "STR_MAI_useRadioShort"
	],
	// Category, Subcategory
	["MAI", "4. AI Radio"],
	// Extra params, depending on settings type
...
[
	...
	// Title, Tooltip
	[
		localize "STR_MAI_radioDistance",
		localize "STR_MAI_radioDistanceShort"
	],
	// Category, Subcategory
	["MAI", "4. AI Radio"],
	// Extra params, depending on settings type
...
[
	...
	// Category, Subcategory
	["MAI - AI skill", "AI Additional options"],
	// Extra params, depending on settings type
	[-1, 100, -1, 0],
	// Is global
	true,
