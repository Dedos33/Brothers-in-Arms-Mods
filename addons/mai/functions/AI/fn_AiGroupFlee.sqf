...
[_group] call MadinAI_fnc_AiPTSDamnesia;
...
private _buildingFound = [_group, _runPosBuildings, 75] call MadinAI_fnc_AiGroupMoveToBuilding;
...
_buildingFound = [_group, _runPos, 100] call MadinAI_fnc_AiGroupMoveToBuilding;
if (_buildingFound)exitWith {};
